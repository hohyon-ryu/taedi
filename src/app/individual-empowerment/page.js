...
export const metadata = {
  ...
  description: "개인의 강화로 사회와 경제질서가 어떻게 변하는지에 대한 연구와 인사이트를 제공합니다.",
        ...
        <div className="audio-section">
          <div className="audio-player-container">
            <audio controls className="audio-player">
              <source src="/static/audio/개인 강화, 공동체, 국가의 변화.m4a" type="audio/mp4" />
          ...
          <div className="audio-info">
            <p>
              이 오디오에서는 디지털 기술의 발전으로 인한 개인 역량 강화가 어떻게 
              사회 구조와 경제 질서에 변화를 가져오는지 탐구합니다. 개인의 
              역량이 강화됨에 따라 공동체 형성 방식과 국가의 역할이 어떻게 
              재정의되는지에 대해 논의합니다.
            </p>
          </div>
        </div>
