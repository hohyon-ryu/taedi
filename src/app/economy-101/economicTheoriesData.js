export const theories = [
  ...
  },
  {
    ...
    diagramClass: "chicago",
    emergenceContext:
      "케인즈주의적 정부 개입이 확대되었으나, 정부 정책이 항상 공익을 달성하지 못하고 비효율성을 드러내는 경우가 발생했습니다. 정치인, 관료, 유권자 등 정치 과정 참여자들의 사적 이익 추구 행동을 경제학적으로 분석하여 '정부 실패'의 가능성을 설명하려는 시도에서 발전했습니다.",
  },
  {
    id: "complexity",
    name: "복잡성 경제학",
    ...
    diagramClass: "modern",
    emergenceContext:
      "전통 경제학의 선형적이고 균형 중심적인 모델이 현실의 동태적이고 예측 불가능한 경제 현상을 설명하는 데 한계가 있다는 비판이 제기되었습니다. 생물학, 물리학 등 자연과학의 복잡계 이론을 경제 시스템 분석에 도입하여, 행위자들의 상호작용과 시스템의 진화 과정을 이해하려는 새로운 접근으로 등장했습니다.",
  },
];
