export const theories = [
  ...
  },
  {
    ...
    realWorldApplication: {
      ...
      story: "2008년 글로벌 금융위기 발생 시, 벤 버냉키 당시 연준 의장은 대공황 연구를 바탕으로 적극적인 통화정책을 펼쳤습니다. 그는 전통적인 금리 인하 정책을 넘어 대규모 자산 매입을 통한 양적완화(QE)를 단행하여 시장에 유동성을 공급하고 금융 시스템 붕괴를 막는 데 기여했습니다. 이러한 정책은 신케인즈주의적 아이디어에 기반하여 위기 상황에서 중앙은행의 적극적인 역할을 강조한 사례로 평가받습니다.",
      figures: [
        { nameKr: "벤 버냉키", nameEn: "Ben Bernanke", role: "미국 연방준비제도 의장" }
      ]
    }
  },
];
