      ...
      <div className="team-content">
        ...
        <div
          className={`team-introduction ${
            introInView ? "animate-fade-up visible" : "animate-fade-up"
          }`}
          ref={introRef}
        >
        ...
        <div className="team-members" itemProp="members" ref={membersRef}>
          {/* Team Leader */}
          <div
            className={`team-member ${
              membersInView ? "animate-fade-up visible" : "animate-fade-up"
            }`}
            itemScope
          ...
          >
            ...
            <div className="member-info">
              <ul>
                ...
                <li>
                  Completed Ph.D. coursework in Intelligence and Information at{" "}
                  <span itemProp="alumniOf">Seoul National University</span>
                </li>
                <li>
          ...
          >
            ...
            <div className="member-info">
              <ul>
                ...
                <li>
                  Expert in science and technology policy, regulations, and data
                  analysis
                </li>
                <li>
          ...
          >
            ...
            <div className="member-info">
              <ul>
                ...
                <li>Responsible for global case studies and data collection</li>
                <li>Supports research result organization and visualization</li>
                <li>Promotes research findings through social media</li>
                <li>
                  Interest in international cooperation and governance models in
